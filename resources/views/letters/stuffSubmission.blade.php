...
@section('title', 'Submission | Barang')
@section('content')
    <div>
    <!-- Kop surat -->
        <header class="mb-4">
                ...
                <tr>
                    ...
                    <td width="400px">
                        <p class="mb-0 text-center"><b>UNIVERSITAS TEKNOLOGI BANDUNG <br> 
                            ...
                            (022)5224000</b></p>
                        <hr>
                        <h1 class="text-center" style="font-size: 14pt;">PEMINJAMAN BARANG</h1>
                    </td>
                ...
                <div class="approval-item">
                    ...
                    <div class="approval-item">
                        ...
                        @if($loans->is_wr_approve != null)
                            <img style="width: 150px;" class="alert alert-success text-white p-1" src="{{asset('img/mengetahui.png')}}" alt="Mengetahui">
                            <div id="sign">
