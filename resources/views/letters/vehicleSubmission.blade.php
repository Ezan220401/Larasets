...
@section('title', 'Submission | Kendaraan')
...
@section('content')
    ...
    <!-- Kop surat -->
                ...
                <tr>
                    ...
                    <td width="400px">
                        <p class="mb-0 text-center"><b>UNIVERSITAS TEKNOLOGI BANDUNG <br> 
                            ...
                            (022)5224000</b></p>
                        <hr>
                        <h1 class="text-center" style="font-size: 14pt;">PEMINJAMAN KENDARAAN</h1>
                    </td>
        ...
        <main>
            ...
            @if($assetFiltered)
            <div id="opening">
                <p class="text-justify">Kepada yang terhormat, Wakil Rektor Bidang Pengembangan SDM, Keuangan dan Aset,
                    <br>Di Tempat
                </p>
                ...
                <p class="text-justify"><t>Bermaksud untuk mengajukan permohonan penggunaan kendaraan {{ $loans->loan_asset_name }} milik Universitas Teknologi Bandung.</p>
            </div>
                ...
                <div id="approval" class="approval-grid">
                    <div class="approval-item">
                        ...
                        <img style="width: 150px;" class="alert alert-success text-white p-1" src="{{asset('img/menyetujui.png')}}" alt="Menyetujui">
                            <div>
                                <p id="sign">{{ $assetFiltered->is_coordinator_approve }}</p></div>
                    ...
                    <div class="approval-item">
                        ...
                        <div>
                        <p id="sign">{{$assetFiltered->applicant_name}}</p></div>
                    </div>
                    <div class="approval-item">
                        <h5>Wakil Rektor</h5>
                        @if($assetFiltered->is_wr_approve != null)
                            <img style="width: 150px;" class="alert alert-primary text-white p-1" src="{{asset('img/mengetahui.png')}}" alt="Mengetahui">
                            <div>
                                <p id="sign">{{ $assetFiltered->is_wr_approve }}</p></div>
                        @elseif ($assetFiltered->is_reject != null)
                            <img style="width: 150px;" class="alert alert-danger text-white p-1" src="{{asset('img/menolak.png')}}" alt="Menolak">
                        @else 
                            <p class="bg-secondary text-white p-1">Menunggu</p>
